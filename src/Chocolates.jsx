...
function Chocolates() {
  ...
  const chocolateItems = useSelector(
    (state) => state.product.chocolates
  );
  ...
  return (
    <div className="item-container">
      <h1>Chocolates Galore – Delight in Every Bite 🍫🍬</h1>
          ...
          <div key={product.id}>
            <div className="card h-100 shadow-sm" style={{ width: "250px" }}>
              ...
              <div className="card-body d-flex flex-column">
                ...
                <p className="card-text text-muted">Sweet & delightful</p>
