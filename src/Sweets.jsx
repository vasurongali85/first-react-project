...
function Sweets() {
  ...
  const sweetItems = useSelector((state) => state.product.sweets);
  ...
  const currentItems = sweetItems.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <div className="item-container">
      <h1>Sweet Treats – Indulge Your Taste Buds 🍬🍭</h1>
          ...
          <div key={product.id}>
            <div className="card h-100 shadow-sm" style={{ width: "250px" }}>
              ...
              <div className="card-body d-flex flex-column">
                ...
                <p className="card-text text-muted">Soft and delicious</p>
